...
The mean total number of steps taken per day is `r mean_total`  
The median total number of steps taken per day is `r median_total`
...
The maximum number of steps within the above interval is `r max_steps`
...
The new mean total number of steps taken per day is `r Step_mean`  
The new total number of steps taken per day is `r Step_median`     
There was no difference in mean, but a `r median_difference` change in median after filling the missing values.  
